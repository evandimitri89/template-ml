...
function updateClassName() {
  ...
  document.getElementById("teamClassDisplay1").textContent = class1;
  document.getElementById("teamClassDisplay2").textContent = class2;
}
...
function switchAll() {
  ...
  const className = class1.value;
  class1.value = class2.value;
  class2.value = className;
  updateClassName();
